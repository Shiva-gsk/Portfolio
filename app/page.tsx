    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main>
        <section id="home" className="py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-10 md:p-10">
            <div className="text-center">
              ...
              <p className="about mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-7 md:text-xl md:max-w-3xl">
